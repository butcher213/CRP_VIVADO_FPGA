...
################################################################
# This is a generated script based on design: fifo_test
#
...
proc create_root_design { parentCell } {
  ...
  set din [ create_bd_port -dir I -from 41 -to 0 din ]
  set dout [ create_bd_port -dir O -from 41 -to 0 dout ]
  set empty [ create_bd_port -dir O empty ]
  set full [ create_bd_port -dir O full ]
  set rd_en [ create_bd_port -dir I rd_en ]
  set rst [ create_bd_port -dir I rst ]
  set wr_enm [ create_bd_port -dir I wr_enm ]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins fifo_generator_0/wr_clk]
  ...
  connect_bd_net -net wr_enm_1 [get_bd_ports wr_enm] [get_bd_pins fifo_generator_0/wr_en]
