...
HD_PWD='C:/Users/butchertd/Documents/eaglesat/CRP_VIVADO_FPGA/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axl_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axl_interface.tcl
