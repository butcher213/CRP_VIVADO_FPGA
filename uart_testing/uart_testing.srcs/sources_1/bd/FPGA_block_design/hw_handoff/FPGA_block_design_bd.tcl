...
################################################################
# This is a generated script based on design: FPGA_Block_Design
#
...
# source FPGA_Block_Design_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# central_interface, uart_tx
...
set design_name FPGA_Block_Design
...
proc create_root_design { parentCell } {
  ...
  set FIFO_in [ create_bd_port -dir I -from 39 -to 0 FIFO_in ]
  ...
  set data_line [ create_bd_port -dir O -from 2 -to 0 data_line ]
  ...
  connect_bd_net -net FIFO_in_1 [get_bd_ports FIFO_in] [get_bd_pins uart_tx_0/fifo_in]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins central_interface_0/clk] [get_bd_pins uart_tx_0/UART_clk]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins central_interface_0/rst] [get_bd_pins uart_tx_0/rst]
  ...
  connect_bd_net -net uart_tx_0_data_line [get_bd_ports data_line] [get_bd_pins uart_tx_0/data_line]
