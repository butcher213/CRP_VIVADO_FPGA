...
-- Date        : Thu Feb 28 10:21:47 2019
-- Host        : BEAST running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/butchertd/Documents/eaglesat/uart_testing/uart_testing.srcs/sources_1/bd/FPGA_block_design/ip/FPGA_block_design_uart_tx_0_0/FPGA_block_design_uart_tx_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of FPGA_block_design_uart_tx_0_0_uart_tx is
  ...
  signal \Tx_shift_registers[2]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Tx_shift_registers[3]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Tx_shift_registers[4]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Tx_shift_registers[5]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Tx_shift_registers[6]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Tx_shift_registers[8]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of Tx_enabled_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Tx_shift_registers[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Tx_shift_registers[3]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Tx_shift_registers[4]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Tx_shift_registers[5]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Tx_shift_registers[8]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \current_state[1]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of transmit_lock_i_1 : label is "soft_lutpair3";
begin
  Tx <= \^tx\;
...
Tx_enabled_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A2"
    )
        port map (
...
\Tx_shift_registers[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      I1 => \current_state_reg_n_0_[0]\,
      I2 => \current_state_reg_n_0_[1]\,
      I3 => \Tx_shift_registers_reg_n_0_[2]\,
...
\Tx_shift_registers[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \current_state_reg_n_0_[1]\,
      I5 => \Tx_shift_registers[2]_i_4_n_0\,
...
\Tx_shift_registers[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\Tx_shift_registers[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      O => \Tx_shift_registers[2]_i_4_n_0\
    );
\Tx_shift_registers[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \current_state_reg_n_0_[0]\,
      I4 => \current_state_reg_n_0_[1]\,
      I5 => \Tx_shift_registers[3]_i_4_n_0\,
...
\Tx_shift_registers[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\Tx_shift_registers[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      I1 => \current_state_reg_n_0_[0]\,
      I2 => \current_state_reg_n_0_[1]\,
      I3 => \Tx_shift_registers_reg_n_0_[4]\,
      O => \Tx_shift_registers[3]_i_4_n_0\
    );
\Tx_shift_registers[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \current_state_reg_n_0_[0]\,
      I4 => \current_state_reg_n_0_[1]\,
      I5 => \Tx_shift_registers[4]_i_4_n_0\,
...
\Tx_shift_registers[4]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\Tx_shift_registers[4]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      I1 => \current_state_reg_n_0_[0]\,
      I2 => \current_state_reg_n_0_[1]\,
      I3 => \Tx_shift_registers_reg_n_0_[5]\,
      O => \Tx_shift_registers[4]_i_4_n_0\
    );
\Tx_shift_registers[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \current_state_reg_n_0_[0]\,
      I4 => \current_state_reg_n_0_[1]\,
      I5 => \Tx_shift_registers[5]_i_4_n_0\,
...
\Tx_shift_registers[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\Tx_shift_registers[5]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      I1 => \current_state_reg_n_0_[0]\,
      I2 => \current_state_reg_n_0_[1]\,
      I3 => \Tx_shift_registers_reg_n_0_[6]\,
      O => \Tx_shift_registers[5]_i_4_n_0\
    );
\Tx_shift_registers[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \current_state_reg_n_0_[0]\,
      I4 => \current_state_reg_n_0_[1]\,
      I5 => \Tx_shift_registers[6]_i_4_n_0\,
...
\Tx_shift_registers[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\Tx_shift_registers[6]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      I1 => \current_state_reg_n_0_[0]\,
      I2 => \current_state_reg_n_0_[1]\,
      I3 => \Tx_shift_registers_reg_n_0_[7]\,
      O => \Tx_shift_registers[6]_i_4_n_0\
    );
\Tx_shift_registers[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \Tx_shift_registers[8]_i_3_n_0\,
...
\Tx_shift_registers[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
...
\Tx_shift_registers[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \Tx_shift_registers[8]_i_3_n_0\,
      I5 => \Tx_shift_registers[8]_i_4_n_0\,
...
\Tx_shift_registers[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      ...
      O => \Tx_shift_registers[8]_i_4_n_0\
    );
...
\current_state[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \Tx_shift_registers_reg_n_0_[8]\,
      I3 => \Tx_shift_registers_reg_n_0_[3]\,
...
\current_state[1]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7776"
    )
        port map (
...
\data_line[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\data_line[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\data_line[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
transmit_lock_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
