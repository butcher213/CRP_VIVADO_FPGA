...
HD_PWD='C:/Users/butchertd/Documents/eaglesat/CRP_VIVADO_FPGA/uart_testing/uart_testing.runs/fpga_design_fifo_protector_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_design_fifo_protector_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_design_fifo_protector_0_0.tcl
