...
#
# Generated by export_simulation on Sat Mar 09 10:58:21 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './fpga_design.sh' script.

./fpga_design.sh -reset_run
...
./fpga_design.sh -noclean_files

For more information on the script, please type './fpga_design.sh -help'.
