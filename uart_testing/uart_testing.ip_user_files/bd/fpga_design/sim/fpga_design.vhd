...
entity fpga_design is
  ...
  attribute CORE_GENERATION_INFO of fpga_design : entity is "fpga_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fpga_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of fpga_design : entity is "fpga_design.hwdef";
end fpga_design;

architecture STRUCTURE of fpga_design is
  component fpga_design_fifo_generator_0_0 is
  port (
    rst : in STD_LOGIC;
    wr_clk : in STD_LOGIC;
    rd_clk : in STD_LOGIC;
  ...
  end component fpga_design_fifo_generator_0_0;
...
fifo_generator_0: component fpga_design_fifo_generator_0_0
     port map (
